  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/a699a1b2-f225-434e-b317-1fbbde8e006c" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline border-b-4 border-color-accent text-gray-300'>Contact</p>
                <p className='text-gray-300 pt-4'>Submit the form below or shoot me an email:</p>
                <p className='text-gray-300 pb-4'>calebkartchner2002@gmail.com</p>
            </div>
